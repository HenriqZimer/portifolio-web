    ...
    <footer id="contacto" className="relative z-10 border-t border-blue-500/20 bg-[#060c1a] pt-20 pb-10 px-6 shadow-[0_-20px_50px_rgba(0,0,0,0.3)]">
      <div className="max-w-6xl mx-auto flex flex-col items-center text-center">
        <FadeInSection>
          ...
          <h2 className="text-3xl font-bold text-white/90 mb-6">{t('footer.title')}</h2>
          <p className="text-white/50 max-w-md mb-10 text-sm mx-auto">{t('footer.description')}</p>
        </FadeInSection>
        ...
        <FadeInSection delay={500}>
          <div className="text-white/30 text-xs font-mono">
            © {new Date().getFullYear()} Henrique Zimermann. {t('footer.copyright')}
          </div>
        </FadeInSection>
      </div>
    </footer>
