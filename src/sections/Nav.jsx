    ...
    <nav className="fixed w-full z-50 top-0 border-b border-white/5 bg-[#03050a]/50 backdrop-blur-md transition-all duration-300">
      <div className="max-w-6xl mx-auto px-6 py-4 flex justify-between items-center gap-6">
        ...
        <div className="hidden md:flex gap-6 text-sm font-medium text-white/60">
          <a href="#" className="hover:text-white transition-colors duration-300">{t('nav.links.home')}</a>
          <a href="#skills" className="hover:text-white transition-colors duration-300">{t('nav.links.skills')}</a>
          <a href="#certificacoes" className="hover:text-white transition-colors duration-300">{t('nav.links.certs')}</a>
          <a href="#projetos" className="hover:text-white transition-colors duration-300">{t('nav.links.projects')}</a>
          <a href="#comunidade" className="hover:text-white transition-colors duration-300">{t('nav.links.community')}</a>
          <a href="#contacto" className="hover:text-white transition-colors duration-300">{t('nav.links.contact')}</a>
        </div>
        ...
        >
          <span className={activeLang === 'pt' ? 'text-white' : 'text-white/60'}>{t('nav.language.pt')}</span>
          <span className="text-blue-300/70">/</span>
          <span className={activeLang === 'en' ? 'text-white' : 'text-white/60'}>{t('nav.language.en')}</span>
        </button>
      </div>
    </nav>
  );
